...
// moby/buildkit stays on v0.28.x; these replaces align docker archive helpers, podman/storage,
// and OCI (runtime-spec v1.2.x + CDI v1.0.x + runtime-tools) so the graph compiles together.
replace (
