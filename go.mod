...
// v0.6.x removed OpenInRoot/Reopen; v0.2.x removed archive root aliases docker/go-dockerclient expect.
// runtime-spec v1.3 uses *int64 for LinuxPids.Limit; podman v5.7.x still uses int64 — align with CDI v0.8's stack.
replace (
