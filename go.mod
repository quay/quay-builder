...
// filepath-securejoin v0.6+ removed OpenInRoot/Reopen; moby/go-archive v0.2+ removed archive root aliases docker expects.
// runtime-spec v1.3 uses *int64 for LinuxPids.Limit; podman v5.7.x still uses int64 — align with CDI v0.8's runtime-tools.
replace (
	...
	tags.cncf.io/container-device-interface/specs-go => tags.cncf.io/container-device-interface/specs-go v0.8.0
)
