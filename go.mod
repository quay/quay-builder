...
// v0.6.x dropped root OpenInRoot/Reopen/MkdirAllHandle; v0.2.x dropped archive root aliases docker expects.
// runtime-spec v1.3 uses *int64 for LinuxPids.Limit; podman v5.5.x still passes int64. Pin v1.2.1 and align
